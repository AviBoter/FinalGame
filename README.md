...
אין הרבה משחקים שקשורים בתינוקות בקונספט הזה,
המשחק הוא משחק אקשן אך לא אלים כך שיתאים לכל גיל.
המשחק כרגע למחשב האישי אך הרעיון הוא לסיים אותו (יש עוד המון מה להוסיף ולשפר)
ולהוציא אותו למובייל בגרסת עולם פתוח שמשלבת בין עולם המשחק ושחקנים נוספים ברשת שיתחרו אחד בשני.
</div>
